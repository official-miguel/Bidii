-- ═══════════════════════════════════════════════════════════════════════════
-- Baseline schema — GENERATED from prisma/schema.prisma (75 models) via:
--   prisma migrate diff --from-empty --to-schema prisma/schema.prisma --script
-- Prisma remains the migration authority (see MIGRATION.md). Do not hand-edit.
-- ═══════════════════════════════════════════════════════════════════════════
-- CreateSchema
...
-- CreateTable
CREATE TABLE "AiTimetableConstraint" (
    "id" TEXT NOT NULL,
    "schoolId" TEXT NOT NULL,
    ...
    CONSTRAINT "AiTimetableConstraint_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "AiTimetableConstraint_schoolId_idx" ON "AiTimetableConstraint"("schoolId");
...
-- AddForeignKey
ALTER TABLE "AiTimetableConstraint" ADD CONSTRAINT "AiTimetableConstraint_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "School"("id") ON DELETE CASCADE ON UPDATE CASCADE;
