...
export default function ChannelBadge({ channel }: { channel: "SMS" | "WHATSAPP" | string }) {
  if (channel === "WHATSAPP") {
    return (
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-royal/10 text-royal px-2 py-0.5 text-xs font-medium">
